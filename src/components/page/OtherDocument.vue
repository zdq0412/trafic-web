    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <i class="el-icon-lx-cascades"></i> 其他档案--{{empName}}
                </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            // 获取 easy-mock 的模拟数据
            getData() {
                this.$axios.get("/otherDocument/otherDocumentsByPage",{
                    params:{
            ...
            handleDelete(index, row) {
                ...
                this.$confirm('确定要删除吗？', '提示', {
                    ...
                    .then(() => {
                        this.$axios.delete("/otherDocument/otherDocument/" + row.id).then(res => {
            ...
            saveEdit() {
                ...
                this.$refs.form.validate(validate => {
                    if (validate) {
                        this.$axios.post("/otherDocument/updateOtherDocument" , this.$qs.stringify(this.form)).then(res => {
                            if (res.data.result.resultCode == 200) {
            ...
            saveAdd(){
                ...
                this.$refs.form.validate(validate =>{
                    if(validate){
                        ...
                        this.$axios.post("/otherDocument/otherDocument",this.$qs.stringify(this.form)).then(res=>{
                            if(res.data.result.resultCode==200){
                                this.addVisible = false;
                                this.getData();
                            }else{
