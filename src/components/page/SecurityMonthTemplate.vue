    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <i class="el-icon-lx-cascades"></i>安全生产月模板
                </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            this.uploadUrl = this.$baseURL + "/securityMonthTemplate/securityMonthTemplate";
            this.modifyUrl = this.$baseURL + "/securityMonthTemplate/updateSecurityMonthTemplate";
            this.getData();
        ...
        methods: {
            ...
            getData() {
                this.$axios.get("/securityMonthTemplate/securityMonthTemplatesByPage", {
                    params: {
            ...
            handleDelete(index, row) {
                ...
                this.$confirm('确定要删除吗？', '提示', {
                    ...
                    .then(() => {
                        this.$axios.delete("/securityMonthTemplate/securityMonthTemplate/" + this.form.id).then(res => {
                ...
                this.$refs.form.validate(validate => {
                    if (validate) {
                        if(this.isSelectUploadFile)
                            ...
                            this.$axios.post("/securityMonthTemplate/updateSecurityMonthTemplateNoFile",this.$qs.stringify(this.form))
                                .then(res=>{
                                    this.editVisible = false;
                                    this.getData();
                                    this.isSelectUploadFile=false;
