    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <i class="el-icon-lx-cascades"></i>风险排查档案模板
                </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
...
import {validateUploadFile} from "../common/validate";
    ...
    export default {
        ...
        created() {
            ...
            this.uploadUrl = this.$baseURL + "/riskCheckTemplate/riskCheckTemplate";
            this.modifyUrl = this.$baseURL + "/riskCheckTemplate/updateRiskCheckTemplate";
            this.getData();
        ...
        methods: {
            ...
            getData() {
                this.$axios.get("/riskCheckTemplate/riskCheckTemplatesByPage", {
                    params: {
            ...
            handleDelete(index, row) {
                ...
                this.$confirm('确定要删除吗？', '提示', {
                    ...
                    .then(() => {
                        this.$axios.delete("/riskCheckTemplate/riskCheckTemplate/" + this.form.id).then(res => {
                ...
                this.$refs.form.validate(validate => {
                    if (validate) {
                        if(this.isSelectUploadFile)
                            ...
                            this.$axios.post("/riskCheckTemplate/updateRiskCheckTemplateNoFile",this.$qs.stringify(this.form))
                                .then(res=>{
                                    this.editVisible = false;
                                    this.getData();
                                    this.isSelectUploadFile=false;
