...
<script>
    ...
    export default {
        ...
        created() {
            ...
            this.uploadUrl = this.$baseURL + "/securityActivity/securityActivity";
            this.modifyUrl = this.$baseURL + "/securityActivity/updateSecurityActivity";
            this.getData();
        },
        methods: {
            ...
            getData() {
                this.$axios.get("/securityActivity/securityActivitysByPage", {
                    params: {
            ...
            handleDelete(index, row) {
                ...
                this.$confirm('确定要删除吗？', '提示', {
                    ...
                    .then(() => {
                        this.$axios.delete("/securityActivity/securityActivity/" + this.form.id).then(res => {
                ...
                this.$refs.form.validate(validate => {
                    if (validate) {
                        if(this.isSelectUploadFile)
                            ...
                            this.$axios.post("/securityActivity/updateSecurityActivityNoFile",this.$qs.stringify(this.form))
                                .then(res=>{
                                    this.editVisible = false;
                                    this.getData();
                                    this.isSelectUploadFile=false;
