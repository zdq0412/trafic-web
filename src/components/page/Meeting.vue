<template>
    <div>
        ...
        <el-dialog title="" :visible.sync="showContentVisible" width="50%">
            <div id="printContent">
                <div class="titleDiv">
                    <div class="titleName">安全生产会议记录</div>
                ...
                <div>
                    <div  class="meetingName">{{meeting.name}}</div>
                    <table class="meetingTable" cellspacing="0" cellpadding="0">
                        <tr>
                ...
                <div class="signInFormDiv">
                    <table class="signInFormTable" cellspacing="0" cellpadding="0">
                        <caption class="signInFormTitle">会议签到表</caption>
                        <tr>
...
<style scoped>
 ...
 @media print {
    ...
    .meetingName{
        font-size: 18px;letter-spacing: 10px;text-align: center;width:100%;height:40%;
    }

    .meetingTable{
        width: 170mm;margin-left:20mm;margin-right:20mm;
    }

    .finalDecisionDiv{
        width: 170mm;margin-left:20mm;margin-right:20mm;text-align: center;border: 1px solid black;height:30px;line-height:30px;
    }

    .finalDecision{
        width: 170mm;margin-left:20mm;margin-right:20mm;;text-align: center;border: 1px solid black;
    }

    .finalDecisionContent{
        height:260mm;width:100%;
    }
    ...
    .signInFormTitle{
        font-size: 18px;letter-spacing: 10px;margin-top: 5mm;
    }

    .photoDiv{
        width: 170mm;margin-left:20mm;margin-right:20mm; height: 232mm;
    }
 }
    /***---------------------------------------------------------------------**/
    @media screen {
        ...
        .addr{
            border-bottom: black solid 1px;width: 65%;display: inline-block;
        }
        ...
        .finalDecisionDiv{
            width: 98%;margin-left:auto;margin-right:auto;text-align: center;border: 1px solid black;height:30px;line-height:30px;
        }

        .finalDecision{
            width: 98%;margin-left:auto;margin-right:auto;text-align: center;border: 1px solid black;
        }
        ...
        .signInFormTitle{
            font-size: 18px;letter-spacing: 10px;margin-top: 5px;
        }

        .photoDiv{
            width: 100%;margin-left:20px;margin-right:20px; height:500px;
        }
    }
