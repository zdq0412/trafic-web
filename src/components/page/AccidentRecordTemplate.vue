                ...
                <el-row v-if="!haveOrg">
                    <el-col>
                        <el-form-item label="企业类别">
                            <el-select v-model="editableForm.orgCategoryId"  @change="$set(editableForm,orgCategoryId)" placeholder="请选择" style="width: 100%;" >
                                <el-option
            ...
            handleDelete(index, row) {
                ...
                this.$confirm('确定要删除吗？', '提示', {
                    type: 'warning'
                        ...
                        this.$axios.delete("/accidentRecordTemplate/accidentRecordTemplate/" + row.id).then(res => {
