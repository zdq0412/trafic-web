    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <i class="el-icon-lx-cascades"></i> 预设职位
                </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getData() {
                this.$axios.get("/commonPosition/commonPositionsByPage",{
                    params:{
            ...
            handleDelete(index, row) {
                ...
                this.$confirm('确定要删除吗？', '提示', {
                    ...
                    .then(() => {
                        this.$axios.delete("/commonPosition/commonPosition/" + row.id).then(res => {
            ...
            saveEdit() {
                this.$refs.form.validate(validate => {
                    ...
                    if (validate) {
                        this.$axios.post("/commonPosition/commonPosition", this.$qs.stringify(this.form)).then(res => {
                            if (res.data.result.resultCode == 200) {
