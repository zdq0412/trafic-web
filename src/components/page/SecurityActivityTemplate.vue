    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <i class="el-icon-lx-cascades"></i>其他安全活动模板
                </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
...
import {validateUploadFile} from "../common/validate";
    ...
    export default {
        ...
        created() {
            ...
            this.uploadUrl = this.$baseURL + "/securityActivityTemplate/securityActivityTemplate";
            this.modifyUrl = this.$baseURL + "/securityActivityTemplate/updateSecurityActivityTemplate";
            this.getData();
        ...
        methods: {
            ...
            getData() {
                this.$axios.get("/securityActivityTemplate/securityActivityTemplatesByPage", {
                    params: {
            ...
            handleDelete(index, row) {
                ...
                this.$confirm('确定要删除吗？', '提示', {
                    ...
                    .then(() => {
                        this.$axios.delete("/securityActivityTemplate/securityActivityTemplate/" + this.form.id).then(res => {
                ...
                this.$refs.form.validate(validate => {
                    if (validate) {
                        if(this.isSelectUploadFile)
                            ...
                            this.$axios.post("/securityActivityTemplate/updateSecurityActivityTemplateNoFile",this.$qs.stringify(this.form))
                                .then(res=>{
                                    this.editVisible = false;
                                    this.getData();
                                    this.isSelectUploadFile=false;
