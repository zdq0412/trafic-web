    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <i class="el-icon-lx-cascades"></i>安全文化建设模板
                </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
...
import {validateUploadFile} from "../common/validate";
    ...
    export default {
        ...
        created() {
            ...
            this.uploadUrl = this.$baseURL + "/securityBuildTemplate/securityBuildTemplate";
            this.modifyUrl = this.$baseURL + "/securityBuildTemplate/updateSecurityBuildTemplate";
            this.getData();
        ...
        methods: {
            ...
            handleDelete(index, row) {
                ...
                this.$confirm('确定要删除吗？', '提示', {
                    ...
                    .then(() => {
                        this.$axios.delete("/securityBuildTemplate/securityBuildTemplate/" + this.form.id).then(res => {
                ...
                this.$refs.form.validate(validate => {
                    if (validate) {
                        if(this.isSelectUploadFile)
                            ...
                            this.$axios.post("/securityBuildTemplate/updateSecurityBuildTemplateNoFile",this.$qs.stringify(this.form))
                                .then(res=>{
                                    this.editVisible = false;
                                    this.getData();
                                    this.isSelectUploadFile=false;
