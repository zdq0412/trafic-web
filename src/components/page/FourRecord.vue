    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <i class="el-icon-lx-cascades"></i>四不放过记录
                </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            this.uploadUrl = this.$baseURL + "/fourRecord/fourRecord";
            this.modifyUrl = this.$baseURL + "/fourRecord/updateFourRecord";
            this.getData();
        },
        methods: {
            fileupload_edit(){
            ...
            getData() {
                this.$axios.get("/fourRecord/fourRecordsByPage", {
                    params: {
            ...
            handleDelete(index, row) {
                ...
                this.$confirm('确定要删除吗？', '提示', {
                    ...
                    .then(() => {
                        this.$axios.delete("/fourRecord/fourRecord/" + this.form.id).then(res => {
                ...
                this.$refs.form.validate(validate => {
                    if (validate) {
                        if(this.isSelectUploadFile)
                            ...
                            this.$axios.post("/fourRecord/updateFourRecordNoFile",this.$qs.stringify(this.form))
                                .then(res=>{
                                    this.editVisible = false;
                                    this.getData();
                                    this.isSelectUploadFile=false;
