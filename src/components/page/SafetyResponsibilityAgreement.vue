    ...
    export default {
        ...
        data() {
            return {
                ...
                uploadUrl:'',
                param:{type:'safetyResponsibilityAgreement'},
                headers:{
        ...
        methods: {
            ...
            findTemplates(){
                this.$axios.get("/empArchivesTemplate/empArchivesTemplatesByPage",{
                    params:{
                        type:'safetyResponsibilityAgreement',
            ...
            // 获取 easy-mock 的模拟数据
            getData() {
                this.$axios.get("/safetyResponsibilityAgreement/safetyResponsibilityAgreementsByPage",{
                    params:{
            ...
            saveEdit() {
                this.$refs.form.validate(validate => {
                    if (validate) {
                        ...
                        this.$axios.put("/safetyResponsibilityAgreement/safetyResponsibilityAgreement?" + this.$qs.stringify(this.form)).then(res => {
                            if (res.data.result.resultCode == 200) {
