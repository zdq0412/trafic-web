    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <i class="el-icon-lx-cascades"></i>应急预案演练模板
                </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            this.uploadUrl = this.$baseURL + "/emergencyPlanDrillTemplate/emergencyPlanDrillTemplate";
            this.modifyUrl = this.$baseURL + "/emergencyPlanDrillTemplate/updateEmergencyPlanDrillTemplate";
            this.getData();
        ...
        methods: {
            ...
            handleDelete(index, row) {
                ...
                this.$confirm('确定要删除吗？', '提示', {
                    ...
                    .then(() => {
                        this.$axios.delete("/emergencyPlanDrillTemplate/emergencyPlanDrillTemplate/" + this.form.id).then(res => {
                ...
                this.$refs.form.validate(validate => {
                    if (validate) {
                        if(this.isSelectUploadFile)
                            ...
                            this.$axios.post("/emergencyPlanDrillTemplate/updateEmergencyPlanDrillTemplateNoFile",this.$qs.stringify(this.form))
                                .then(res=>{
                                    this.editVisible = false;
                                    this.getData();
                                    this.isSelectUploadFile=false;
