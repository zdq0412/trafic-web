    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <i class="el-icon-lx-cascades"></i> 身份证管理
                </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            // 获取 easy-mock 的模拟数据
            getData() {
                this.$axios.get("/idcard/idcardsByPage",{
                    params:{
            ...
            handleDelete(index, row) {
                ...
                this.$confirm('确定要删除吗？', '提示', {
                    ...
                    .then(() => {
                        this.$axios.delete("/idcard/idcard/" + this.form.id).then(res => {
            ...
            saveEdit() {
                this.$refs.form.validate(validate => {
                    if (validate) {
                        ...
                        this.$axios.post("/idcard/updateIDCard" , this.$qs.stringify(this.form)).then(res => {
                            if (res.data.result.resultCode == 200) {
            ...
            saveAdd(){
                ...
                this.$refs.form.validate(validate =>{
                    if(validate){
                        this.form.empId = this.empId;
                        this.$axios.post("/idcard/idcard",this.$qs.stringify(this.form)).then(res=>{
                            if(res.data.result.resultCode==200){
                                this.addVisible = false;
                                this.getData();
                            }
