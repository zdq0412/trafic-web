    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <i class="el-icon-lx-cascades"></i>作业管理台账模板
                </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            ...
            >
                ...
                <el-table-column prop="jobManagementAccountType.name" label="作业安全类别"></el-table-column>
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            this.uploadUrl = this.$baseURL + "/jobManagementAccountTemplate/jobManagementAccountTemplate";
            this.modifyUrl = this.$baseURL + "/jobManagementAccountTemplate/updateJobManagementAccountTemplate";
            this.getData();
        ...
        methods: {
            ...
            getData() {
                this.$axios.get("/jobManagementAccountTemplate/jobManagementAccountTemplatesByPage", {
                    params: {
            ...
            handleDelete(index, row) {
                ...
                this.$confirm('确定要删除吗？', '提示', {
                    ...
                    .then(() => {
                        this.$axios.delete("/jobManagementAccountTemplate/jobManagementAccountTemplate/" + this.form.id).then(res => {
                ...
                this.$refs.form.validate(validate => {
                    if (validate) {
                        if(this.isSelectUploadFile)
                            ...
                            this.$axios.post("/jobManagementAccountTemplate/updateJobManagementAccountTemplateNoFile",this.$qs.stringify(this.form))
                                .then(res=>{
                                    this.editVisible = false;
                                    this.getData();
                                    this.isSelectUploadFile=false;
