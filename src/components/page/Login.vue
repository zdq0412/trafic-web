<template>
    <div class="login-wrap">
        <el-tabs v-model="activeName" type="card" style="position:absolute;top:50%;left:50%;margin: -400px 0 0 -175px;
width:500px;text-align: center;height:500px;" stretch>
            ...
            <el-tab-pane label="注册" name="register">
                <div class="ms-login">
                    <!--<div class="ms-title">后台管理系统</div>-->
                    <el-form ref="regForm" :rules="rules" :model="form" class="ms-content">
                        ...
                        <el-form-item prop="orgCategoryId">
