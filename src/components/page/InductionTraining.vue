    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <i class="el-icon-lx-cascades"></i> 入职培训管理--{{empName}}
                </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            // 获取 easy-mock 的模拟数据
            getData() {
                this.$axios.get("/inductionTraining/inductionTrainingsByPage",{
                    params:{
            ...
            handleDelete(index, row) {
                ...
                this.$confirm('确定要删除吗？', '提示', {
                    ...
                    .then(() => {
                        this.$axios.delete("/inductionTraining/inductionTraining/" + row.id).then(res => {
            ...
            saveEdit() {
                ...
                this.$refs.form.validate(validate => {
                    if (validate) {
                        this.$axios.post("/inductionTraining/updateInductionTraining", this.$qs.stringify(this.form)).then(res => {
                            if (res.data.result.resultCode == 200) {
            ...
            saveAdd(){
                ...
                this.$refs.form.validate(validate =>{
                    if(validate){
                        ...
                        this.$axios.post("/inductionTraining/inductionTraining",this.$qs.stringify(this.form)).then(res=>{
                            if(res.data.result.resultCode==200){
                                this.addVisible = false;
                                this.getData();
                            }else{
