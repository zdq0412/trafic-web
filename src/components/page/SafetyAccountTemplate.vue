    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <i class="el-icon-lx-cascades"></i>安全投入台账模板
                </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            this.uploadUrl = this.$baseURL + "/safetyAccountTemplate/safetyAccountTemplate";
            this.modifyUrl = this.$baseURL + "/safetyAccountTemplate/updateSafetyAccountTemplate";
            this.getData();
        ...
        methods: {
            ...
            handleDelete(index, row) {
                ...
                this.$confirm('确定要删除吗？', '提示', {
                    ...
                    .then(() => {
                        this.$axios.delete("/safetyAccountTemplate/safetyAccountTemplate/" + this.form.id).then(res => {
                ...
                this.$refs.form.validate(validate => {
                    if (validate) {
                        if(this.isSelectUploadFile)
                            ...
                            this.$axios.post("/safetyAccountTemplate/updateSafetyAccountTemplateNoFile",this.$qs.stringify(this.form))
                                .then(res=>{
                                    this.editVisible = false;
                                    this.getData();
                                    this.isSelectUploadFile=false;
