...
<script>
    ...
    export default {
        ...
        data() {
            return {
                ...
                options: [{
                    ...
                    value: 'safetyResponsibilityAgreement',
                    label: '安全责任书'
                },{
        ...
        created() {
            ...
            this.uploadUrl = this.$baseURL + "/empArchivesTemplate/empArchivesTemplate";
            this.modifyUrl = this.$baseURL + "/empArchivesTemplate/updateEmpArchivesTemplate";
            this.getData();
        ...
        methods: {
            ...
            handleDelete(index, row) {
                ...
                this.$confirm('确定要删除吗？', '提示', {
                    ...
                    .then(() => {
                        this.$axios.delete("/empArchivesTemplate/empArchivesTemplate/" + this.form.id).then(res => {
                ...
                this.$refs.form.validate(validate => {
                    if (validate) {
                        if(this.isSelectUploadFile)
                            ...
                            this.$axios.post("/empArchivesTemplate/updateEmpArchivesTemplateNoFile",this.$qs.stringify(this.form))
                                .then(res=>{
                                    this.editVisible = false;
                                    this.getData();
                                    this.isSelectUploadFile=false;
